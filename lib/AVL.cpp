...
// 
// template <typename data_type>
// bool AVL<data_type>::AVL_Delete(data_type target) { return remove(&this->root_, target);}
// 
// template <typename data_type>
// void AVL<data_type>::AVL_Delete(typename AVL<data_type>::node **target) 
// {
// }
// 
// template <typename data_type>
...
//   Tree.AVL_Insert(14);
// 
//   if (Tree.AVL_Delete(6) != true) {
//     std::cout << "the node to delete is not found." << std::endl;
//   }
//   else 
//     std::cout << "successfully delete node." << std::endl;
// 
//   // AVL<int>::node *tmp = Tree.AVL_Find(10);
//   // if (tmp == nullptr) 
